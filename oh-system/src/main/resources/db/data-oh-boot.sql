...
-- ----------------------------
INSERT INTO `gen_base_class` VALUES (1, 'com.iris.framework.mybatis.entity', 'BaseEntity', 'id,creator,create_time,updater,update_time,db_status', '使用该基类，则需要表里有这些字段', '2023-06-15 05:10:26');
