...
import com.iris.system.convert.SysDictTypeConvert;
import com.iris.system.dao.SysDictDataDao;
import com.iris.system.dao.SysDictTypeDao;
import com.iris.system.enums.DictSourceEnum;
import com.iris.system.query.SysDictTypeQuery;
import com.iris.system.service.SysDictTypeService;
...
public class SysDictTypeServiceImpl extends BaseServiceImpl<SysDictTypeDao, SysDictTypeEntity> implements SysDictTypeService, InitializingBean {
    ...
    public SysDictTypeServiceImpl(SysDictDataDao sysDictDataDao, DictionaryTransService dictionaryTransService) {
