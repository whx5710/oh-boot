...
public class DataSourceInterceptor {
    private final Logger log = LoggerFactory.getLogger(DataSourceInterceptor.class);

    private final SysDataSourceProperties sysDataSourceProperties;
    public DataSourceInterceptor(SysDataSourceProperties sysDataSourceProperties){
     ...
     * @throws Throwable
     */
    @Around("execution(* com.iris.support..mapper.*Mapper.*(..))")
