...
-- ----------------------------
INSERT INTO `QRTZ_JOB_DETAILS` VALUES ('OhScheduler', 'TASK_NAME_1', 'system', NULL, 'com.iris.quartz.utils.ScheduleDisallowConcurrentExecution', '0', '1', '0', '0', );
...
-- ----------------------------
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('OhScheduler', 'DESKTOP-1LF75BV1697881631609', 1697882228888, 15000);
...
-- ----------------------------
INSERT INTO `QRTZ_TRIGGERS` VALUES ('OhScheduler', 'TASK_NAME_1', 'system', 'TASK_NAME_1', 'system', NULL, 1697881680000, -1, 5, 'PAUSED', 'CRON', 1697881631000, 0, NULL, 2, '');
...
CREATE TABLE `sys_log_login`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 92 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '登录日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_log_login
-- ----------------------------
INSERT INTO `sys_log_login` VALUES (90, 'admin', '127.0.0.1', '内网IP', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36', 1, 1, '2023-10-21 17:50:54');
INSERT INTO `sys_log_login` VALUES (91, 'admin', '127.0.0.1', '内网IP', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36', 1, 0, '2023-10-21 17:51:23');
...
INSERT INTO `sys_params` VALUES (4, 'websocket连接', 1, 'WS_URL', 'ws://127.0.0.1:8080', 'websocket连接', 0, 10000, '2023-10-06 15:07:55', 10000, '2023-10-06 15:07:55');
...
INSERT INTO `sys_user` VALUES (10001, 'whx', '{bcrypt}$2a$10$LvFSm4kNXo4HLJh1XmXVKu6/sdjbFcjgTxjKvOCNwUAspaw0TPD9W', '王小费', 'http://localhost:8080/upload/20230717/1671258609873_77092.jpg', 0, 'whx5710@qq.com', '15074825710', 1, 0, 1, 0, 10000, '2023-07-17 21:15:47', 10001, '2023-07-17 21:24:54');
