...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_pid` (`parent_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='菜单管理';

-- ----------------------------
-- Records of sys_menu
-- ----------------------------
BEGIN;
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `title`, `path`, `menu_path`, `status`, `hide_in_menu`, `hide_in_tab`, `authority`, `badge`, `badge_type`, `badge_variants`, `affix_tab`, `link`, `type`, `open_style`, `icon`, `keep_alive`, `sort`, `db_status`, `mark`, `creator`, `create_time`, `updater`, `update_time`) VALUES (1, 0, 'Dashboard', '概览', '/dashboard', '/_core/about/index', 1, 0, 0, '', NULL, NULL, NULL, 0, NULL, 'menu', 0, 'lucide:layout-dashboard', 1, 0, 1, NULL, 10000, '2023-09-24 20:13:47', 10000, '2025-05-26 13:39:51');
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `title`, `path`, `menu_path`, `status`, `hide_in_menu`, `hide_in_tab`, `authority`, `badge`, `badge_type`, `badge_variants`, `affix_tab`, `link`, `type`, `open_style`, `icon`, `keep_alive`, `sort`, `db_status`, `mark`, `creator`, `create_time`, `updater`, `update_time`) VALUES (11, 10, 'Menu', '菜单管理', '/system/menu', '/system/menu/list', 1, 0, 0, NULL, 'new', 'normal', 'default', 0, NULL, 'menu', 0, 'carbon:menu', 1, 0, 1, NULL, 10000, '2023-06-04 21:03:59', 10000, '2025-05-19 09:53:17');
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `title`, `path`, `menu_path`, `status`, `hide_in_menu`, `hide_in_tab`, `authority`, `badge`, `badge_type`, `badge_variants`, `affix_tab`, `link`, `type`, `open_style`, `icon`, `keep_alive`, `sort`, `db_status`, `mark`, `creator`, `create_time`, `updater`, `update_time`) VALUES (15, 10, 'Role', '角色管理', '/system/role', '/system/role/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'mdi:account-group', 1, 0, 1, NULL, 10000, '2023-06-04 21:03:59', 10000, '2025-05-08 16:46:19');
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `title`, `path`, `menu_path`, `status`, `hide_in_menu`, `hide_in_tab`, `authority`, `badge`, `badge_type`, `badge_variants`, `affix_tab`, `link`, `type`, `open_style`, `icon`, `keep_alive`, `sort`, `db_status`, `mark`, `creator`, `create_time`, `updater`, `update_time`) VALUES (19, 10, 'Dept', '部门管理', '/system/dept', '/system/dept/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:container-services', 1, 0, 1, NULL, 10000, '2023-06-04 21:03:59', 10000, '2025-05-08 16:46:25');
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `title`, `path`, `menu_path`, `status`, `hide_in_menu`, `hide_in_tab`, `authority`, `badge`, `badge_type`, `badge_variants`, `affix_tab`, `link`, `type`, `open_style`, `icon`, `keep_alive`, `sort`, `db_status`, `mark`, `creator`, `create_time`, `updater`, `update_time`) VALUES (23, 10, 'Params', '参数管理', '/system/params', '/system/params/index', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:delivery-parcel', 1, 0, 1, NULL, 10000, '2023-06-04 21:03:59', 10000, '2025-05-12 11:32:45');
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `title`, `path`, `menu_path`, `status`, `hide_in_menu`, `hide_in_tab`, `authority`, `badge`, `badge_type`, `badge_variants`, `affix_tab`, `link`, `type`, `open_style`, `icon`, `keep_alive`, `sort`, `db_status`, `mark`, `creator`, `create_time`, `updater`, `update_time`) VALUES (27, 10, 'Users', '用户管理', '/system/user', '/system/user/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:user-multiple', 1, 0, 1, NULL, 10000, '2023-06-04 21:03:59', 10000, '2025-05-13 17:01:07');
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `title`, `path`, `menu_path`, `status`, `hide_in_menu`, `hide_in_tab`, `authority`, `badge`, `badge_type`, `badge_variants`, `affix_tab`, `link`, `type`, `open_style`, `icon`, `keep_alive`, `sort`, `db_status`, `mark`, `creator`, `create_time`, `updater`, `update_time`) VALUES (30, 10, 'Dict', '字典管理', '/system/dict', '/system/dict/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:align-horizontal-left', 0, 0, 1, NULL, 10000, '2025-05-19 09:30:58', 10000, '2025-05-19 09:31:43');
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `title`, `path`, `menu_path`, `status`, `hide_in_menu`, `hide_in_tab`, `authority`, `badge`, `badge_type`, `badge_variants`, `affix_tab`, `link`, `type`, `open_style`, `icon`, `keep_alive`, `sort`, `db_status`, `mark`, `creator`, `create_time`, `updater`, `update_time`) VALUES (33, 10, 'Tenant', '租户管理', '/system/tenant', '/system/tenant/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:catalog-publish', 0, 0, 1, NULL, 10000, '2025-05-20 11:07:19', 10000, '2025-05-20 11:08:02');
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `title`, `path`, `menu_path`, `status`, `hide_in_menu`, `hide_in_tab`, `authority`, `badge`, `badge_type`, `badge_variants`, `affix_tab`, `link`, `type`, `open_style`, `icon`, `keep_alive`, `sort`, `db_status`, `mark`, `creator`, `create_time`, `updater`, `update_time`) VALUES (36, 10, 'Post', '岗位管理', '/system/post', '/system/post/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:calls-all', 1, 0, 1, NULL, 10000, '2025-05-20 17:54:23', NULL, NULL);
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `title`, `path`, `menu_path`, `status`, `hide_in_menu`, `hide_in_tab`, `authority`, `badge`, `badge_type`, `badge_variants`, `affix_tab`, `link`, `type`, `open_style`, `icon`, `keep_alive`, `sort`, `db_status`, `mark`, `creator`, `create_time`, `updater`, `update_time`) VALUES (39, 10, 'Attachment', '附件管理', '/system/attachment', '/system/attachment/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:file-storage', 0, 0, 1, NULL, 10000, '2025-06-08 11:26:11', NULL, NULL);
