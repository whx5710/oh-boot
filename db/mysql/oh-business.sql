/*
 ...
 Source Schema         : oh-business

 Target Server Type    : MySQL
 Target Server Version : 80036 (8.0.36)
 File Encoding         : 65001

 Date: 21/04/2024 20:39:47
*/
...
CREATE TABLE `bpmn_flow`  (
  ...
  UNIQUE INDEX `idx_01`(`key_code` ASC) USING BTREE
...
CREATE TABLE `bpmn_flow_node`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_01`(`proc_def_id` ASC) USING BTREE
...
CREATE TABLE `bpmn_task_record`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `bpmn_task_record_proc_inst_id_IDX`(`proc_inst_id` ASC) USING BTREE
...
CREATE TABLE `oh_task_user`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_01`(`task_id` ASC, `user_id` ASC) USING BTREE,
  INDEX `idx_02`(`task_id` ASC) USING BTREE
...
CREATE TABLE `oh_work_order`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_order_code`(`order_code` ASC) USING BTREE
