...
INSERT INTO `sys_menu` (`id`, `parent_id`, `path`, `name`, `component`, `title`, `icon`, `show_badge`, `show_text_badge`, `is_hide`, `is_hide_tab`, `link`, `is_iframe`, `keep_alive`, `fixed_tab`, `type`, `authority`, `sort`, `mark`, `db_status`, `creator`, `create_time`, `updater`, `update_time`) VALUES (4, 0, '/system', 'System', '/index/index', '系统管理', 'ri:list-settings-fill', 0, '', 0, 0, '', 0, 0, 0, 'menu', NULL, 2, NULL, 1, NULL, '2025-09-27 21:53:36', 10000, '2025-10-18 09:49:28');
INSERT INTO `sys_menu` (`id`, `parent_id`, `path`, `name`, `component`, `title`, `icon`, `show_badge`, `show_text_badge`, `is_hide`, `is_hide_tab`, `link`, `is_iframe`, `keep_alive`, `fixed_tab`, `type`, `authority`, `sort`, `mark`, `db_status`, `creator`, `create_time`, `updater`, `update_time`) VALUES (5, 4, '/menu', 'Menu', '/system/menu/index', '菜单管理', 'ri:menu-fold-2-line', 0, '', 0, 0, NULL, NULL, NULL, NULL, 'menu', NULL, NULL, NULL, 1, NULL, '2025-09-27 21:53:34', NULL, NULL);
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `path`, `name`, `component`, `title`, `icon`, `show_badge`, `show_text_badge`, `is_hide`, `is_hide_tab`, `link`, `is_iframe`, `keep_alive`, `fixed_tab`, `type`, `authority`, `sort`, `mark`, `db_status`, `creator`, `create_time`, `updater`, `update_time`) VALUES (8, 4, '/role', 'Role', '/system/role/index', '角色管理', 'ri:contacts-book-3-line', 0, '', 0, 0, '', 0, 1, 0, 'menu', NULL, 1, '', 1, 10000, '2025-10-02 19:26:23', NULL, NULL);
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `path`, `name`, `component`, `title`, `icon`, `show_badge`, `show_text_badge`, `is_hide`, `is_hide_tab`, `link`, `is_iframe`, `keep_alive`, `fixed_tab`, `type`, `authority`, `sort`, `mark`, `db_status`, `creator`, `create_time`, `updater`, `update_time`) VALUES (12, 4, '/user', 'User', '/system/user/index', '用户管理', 'ri:user-follow-line', 0, '', 0, 0, '', 0, 1, 0, 'menu', NULL, 3, '', 1, 10000, '2025-10-04 14:43:48', 10000, '2025-10-04 14:44:46');
INSERT INTO `sys_menu` (`id`, `parent_id`, `path`, `name`, `component`, `title`, `icon`, `show_badge`, `show_text_badge`, `is_hide`, `is_hide_tab`, `link`, `is_iframe`, `keep_alive`, `fixed_tab`, `type`, `authority`, `sort`, `mark`, `db_status`, `creator`, `create_time`, `updater`, `update_time`) VALUES (13, 4, '/dept', 'Dept', '/system/dept/index', '部门管理', 'ri:home-wifi-line', 0, '', 0, 0, '', 0, 1, 0, 'menu', NULL, 1, '', 1, 10000, '2025-10-04 19:10:25', NULL, NULL);
