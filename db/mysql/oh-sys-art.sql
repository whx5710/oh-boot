...
CREATE TABLE `sys_menu` (
  ...
  `name` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '组件名',
  ...
  `icon` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '路由图标',
  `show_badge` tinyint(1) DEFAULT NULL COMMENT '是否显示徽章',
  `show_text_badge` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '文本徽章',
  `is_hide` tinyint(1) DEFAULT NULL COMMENT '是否在菜单中隐藏',
  `is_hide_tab` tinyint(1) DEFAULT NULL COMMENT '是否在标签页中隐藏',
  `link` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '外部链接',
