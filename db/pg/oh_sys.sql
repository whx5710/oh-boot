...
CREATE TABLE online_table_column  (
  ...
  column_type varchar(100) NULL DEFAULT NULL COMMENT '字段类型',
  column_pk smallint NULL DEFAULT NULL COMMENT '字段主键 0：否  1：是',
  column_null smallint NULL DEFAULT NULL COMMENT '字段为空 0：否  1：是',
  form_item smallint NULL DEFAULT NULL COMMENT '表单项 0：否  1：是',
  form_required smallint NULL DEFAULT NULL COMMENT '表单必填 0：否  1：是',
  form_input varchar(100) NULL DEFAULT NULL COMMENT '表单控件',
  form_default varchar(100) NULL DEFAULT NULL COMMENT '表单控件默认值',
  form_dict varchar(100) NULL DEFAULT NULL COMMENT '表单字典',
  grid_item smallint NULL DEFAULT NULL COMMENT '列表项 0：否  1：是',
  grid_sort smallint NULL DEFAULT NULL COMMENT '列表排序 0：否  1：是',
  query_item smallint NULL DEFAULT NULL COMMENT '查询项 0：否  1：是',
  query_type varchar(200) NULL DEFAULT NULL COMMENT '查询方式',
  query_input varchar(200) NULL DEFAULT NULL COMMENT '查询控件',
  sort int NULL DEFAULT NULL COMMENT '排序',
  table_id varchar(32) NULL DEFAULT NULL COMMENT '表id',
  PRIMARY KEY (id)
) COMMENT = 'Online表单字段';
...
CREATE TABLE qrtz_blob_triggers  (
  ...
  blob_data bytea NULL COMMENT '存放持久化Trigger对象',
...
CREATE TABLE qrtz_calendars  (
  ...
  calendar bytea NOT NULL COMMENT '存放持久化calendar对象',
...
CREATE TABLE qrtz_job_details  (
  ...
  job_data bytea NULL COMMENT '存放持久化job对象',
...
CREATE TABLE schedule_job  (
  id bigint NOT NULL COMMENT 'id',
  job_name varchar(200) NULL DEFAULT NULL COMMENT '名称',
  job_group varchar(100) NULL DEFAULT NULL COMMENT '分组',
  bean_name varchar(200) NULL DEFAULT NULL COMMENT 'spring bean名称',
  method varchar(100) NULL DEFAULT NULL COMMENT '执行方法',
  params varchar(2000) NULL DEFAULT NULL COMMENT '参数',
  cron_expression varchar(100) NULL DEFAULT NULL COMMENT 'cron表达式',
  status smallint NULL DEFAULT NULL COMMENT '状态  0：暂停  1：正常',
  concurrent smallint NULL DEFAULT NULL COMMENT '是否并发  0：禁止  1：允许',
...
CREATE TABLE schedule_job_log  (
  ...
  job_name varchar(200) NULL DEFAULT NULL COMMENT '任务名称',
  job_group varchar(100) NULL DEFAULT NULL COMMENT '任务组名',
  bean_name varchar(200) NULL DEFAULT NULL COMMENT 'spring bean名称',
  method varchar(100) NULL DEFAULT NULL COMMENT '执行方法',
  params varchar(2000) NULL DEFAULT NULL COMMENT '参数',
  status smallint NOT NULL COMMENT '任务状态    0：失败    1：成功',
  error varchar(2000) NULL DEFAULT NULL COMMENT '异常信息',
...
CREATE TABLE sms_platform  (
  ...
  access_key varchar(100) NULL DEFAULT NULL COMMENT 'AccessKey',
  secret_key varchar(100) NULL DEFAULT NULL COMMENT 'SecretKey',
...
CREATE TABLE sys_attachment  (
  ...
  platform varchar(50) NULL DEFAULT NULL COMMENT '存储平台',
  db_status smallint NULL DEFAULT 1 COMMENT '数据状态标识 0：已删除，1：正常',
  creator bigint NULL DEFAULT NULL COMMENT '创建者',
  create_time timestamp NULL DEFAULT NULL COMMENT '创建时间',
  updater bigint NULL DEFAULT NULL COMMENT '更新者',
...
CREATE TABLE sys_dept  (
  ...
  note varchar(800) NULL DEFAULT NULL COMMENT '备注',
  sort int NULL DEFAULT NULL COMMENT '排序',
  db_status smallint NULL DEFAULT 1 COMMENT '数据状态标识 0：已删除，1：正常',
  creator bigint NULL DEFAULT NULL COMMENT '创建者',
  create_time timestamp NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE sys_dict_data  (
  ...
  dict_value varchar(255) NULL DEFAULT NULL COMMENT '字典值',
  label_class varchar(30) NULL DEFAULT NULL COMMENT '标签样式',
  remark varchar(255) NULL DEFAULT NULL COMMENT '备注',
  sort int NULL DEFAULT NULL COMMENT '排序',
  db_status smallint NULL DEFAULT 1 COMMENT '数据状态标识 0：已删除，1：正常',
  creator bigint NULL DEFAULT NULL COMMENT '创建者',
...
CREATE TABLE sys_dict_type  (
  ...
  dict_sql varchar(500) NULL DEFAULT NULL COMMENT '动态SQL',
  remark varchar(255) NULL DEFAULT NULL COMMENT '备注',
  sort int NULL DEFAULT NULL COMMENT '排序',
  db_status smallint NULL DEFAULT 1 COMMENT '数据状态标识 0：已删除，1：正常',
  creator bigint NULL DEFAULT NULL COMMENT '创建者',
...
CREATE TABLE sys_log_login  (
  ...
  ip varchar(32) NULL DEFAULT NULL COMMENT '登录IP',
  address varchar(32) NULL DEFAULT NULL COMMENT '登录地点',
...
CREATE TABLE sys_log_operate  (
  id bigint NOT NULL COMMENT 'id',
  module varchar(100) NULL DEFAULT NULL COMMENT '模块名',
  name varchar(100) NULL DEFAULT NULL COMMENT '操作名',
  req_uri varchar(200) NULL DEFAULT NULL COMMENT '请求URI',
  req_method varchar(20) NULL DEFAULT NULL COMMENT '请求方法',
  ...
  real_name varchar(50) NULL DEFAULT NULL COMMENT '操作人',
  result_msg varchar(500) NULL DEFAULT NULL COMMENT '返回消息',
  create_time timestamp NULL DEFAULT NULL COMMENT '创建时间',
  tenant_id varchar(30) NULL DEFAULT NULL COMMENT '租户ID',
  PRIMARY KEY (id)
) COMMENT = '操作日志';
...
CREATE TABLE sys_menu  (
  ...
  name varchar(200) NULL DEFAULT NULL COMMENT '菜单名称',
  title varchar(50) NULL DEFAULT NULL COMMENT '标题',
  path varchar(200) NULL DEFAULT NULL COMMENT '显示路径',
  menu_path varchar(80) NULL DEFAULT NULL COMMENT '页面组件路径',
  status int NULL DEFAULT 1 COMMENT '状态 0停用 1有效',
  hide_in_menu smallint NULL DEFAULT 0 COMMENT '菜单是否隐藏',
  hide_in_tab smallint NULL DEFAULT 0 COMMENT '标签是否隐藏',
  authority varchar(500) NULL DEFAULT NULL COMMENT '授权标识(多个用逗号分隔，如：sys:menu:list,sys:menu:save)',
  badge varchar(50) NULL DEFAULT NULL COMMENT '用于配置页面的徽标，会在菜单显示',
  badge_type varchar(20) NULL DEFAULT NULL COMMENT '用于配置页面的徽标类型，dot 为小红点，normal 为文本',
  badge_variants varchar(30) NULL DEFAULT NULL COMMENT '用于配置页面的徽标颜色',
  affix_tab smallint NULL DEFAULT 0 COMMENT '用于配置页面是否固定标签页，固定后页面不可关闭',
  link varchar(255) NULL DEFAULT NULL COMMENT '用于配置外链跳转路径',
  type varchar(10) NULL DEFAULT 'menu' COMMENT '类型:  catalog | menu | action',
  open_style smallint NULL DEFAULT 0 COMMENT '打开方式   0：内部   1：外部',
  icon varchar(50) NULL DEFAULT NULL COMMENT '菜单图标',
  keep_alive smallint NULL DEFAULT 0 COMMENT '菜单缓存',
  sort int NULL DEFAULT NULL COMMENT '排序',
  db_status smallint NULL DEFAULT 1 COMMENT '数据状态标识 0：已删除，1：正常',
  mark varchar(100) NULL DEFAULT NULL COMMENT '备注',
  creator bigint NULL DEFAULT NULL COMMENT '创建者',
  create_time timestamp NULL DEFAULT NULL COMMENT '创建时间',
  updater bigint NULL DEFAULT NULL COMMENT '更新者',
  update_time timestamp NULL DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `sys_tenant_member`  (
  ...
  `dept_id` bigint NULL DEFAULT NULL COMMENT '默认根部门',
