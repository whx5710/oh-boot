...
CREATE TABLE oh_sys.online_table_column (
  ...
  column_pk smallint DEFAULT NULL,
  column_null smallint DEFAULT NULL,
  form_item smallint DEFAULT NULL,
  form_required smallint DEFAULT NULL,
  form_input varchar(100) DEFAULT NULL,
  form_default varchar(100) DEFAULT NULL,
  form_dict varchar(100) DEFAULT NULL,
  grid_item smallint DEFAULT NULL,
  grid_sort smallint DEFAULT NULL,
  query_item smallint DEFAULT NULL,
  query_type varchar(200) DEFAULT NULL,
  query_input varchar(200) DEFAULT NULL,
  sort int DEFAULT NULL,
  table_id varchar(32) DEFAULT NULL,
  PRIMARY KEY (id)
);

-- Comments for online_table_column
...
-- Comments for qrtz_blob_triggers
...
-- Comments for qrtz_cron_triggers
...
-- Comments for qrtz_fired_triggers
...
-- ----------------------------
INSERT INTO oh_sys.qrtz_job_details (sched_name, job_name, job_group, description, job_class_name, is_durable, is_nonconcurrent, is_update_data, requests_recovery, job_data) VALUES ('OhScheduler', 'TASK_NAME_1', 'system', NULL, 'com.finn.sys.quartz.utils.ScheduleDisallowConcurrentExecution', '0', '1', '0', '0', '\xAC');
...
-- Comments for qrtz_paused_trigger_grps
...
-- Comments for qrtz_scheduler_state
...
-- Comments for qrtz_simple_triggers
...
-- Comments for qrtz_simprop_triggers
...
-- ----------------------------
-- Table structure for oh_sys.schedule_job
-- ----------------------------
...
CREATE TABLE oh_sys.schedule_job (
  ...
  concurrent smallint DEFAULT NULL,
  remark varchar(255) DEFAULT NULL,
  db_status smallint DEFAULT '1',
...
-- Comments for oh_sys.schedule_job
...
-- ----------------------------
-- Records of oh_sys.schedule_job
-- ----------------------------
...
-- ----------------------------
-- Table structure for oh_sys.schedule_job_log
-- ----------------------------
...
-- Comments for oh_sys.schedule_job_log
...
-- ----------------------------
-- Table structure for oh_sys.sms_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for oh_sys.sms_platform
-- ----------------------------
...
-- Comments for oh_sys.sms_platform
...
CREATE TABLE oh_sys.sys_dict_data (
  ...
  label_class varchar(30) DEFAULT NULL,
  remark varchar(255) DEFAULT NULL,
  sort int DEFAULT NULL,
  db_status smallint DEFAULT '1',
  creator bigint DEFAULT NULL,
...
CREATE TABLE oh_sys.sys_dict_type (
  ...
  dict_source smallint DEFAULT '0',
  dict_sql varchar(500) DEFAULT NULL,
  remark varchar(255) DEFAULT NULL,
  sort int DEFAULT NULL,
  db_status smallint DEFAULT '1',
  creator bigint DEFAULT NULL,
...
CREATE TABLE oh_sys.sys_log_operate (
  ...
  req_uri varchar(200) DEFAULT NULL,
  req_method varchar(20) DEFAULT NULL,
  req_params text,
  ip varchar(32) DEFAULT NULL,
  address varchar(32) DEFAULT NULL,
  user_agent varchar(500) DEFAULT NULL,
  operate_type smallint DEFAULT NULL,
...
CREATE TABLE oh_sys.sys_menu (
  ...
  menu_path varchar(80) DEFAULT NULL,
  status int DEFAULT 1,
  hide_in_menu smallint DEFAULT 0,
  hide_in_tab smallint DEFAULT 0,
  authority varchar(500) DEFAULT NULL,
  badge varchar(50) DEFAULT NULL,
  badge_type varchar(20) DEFAULT NULL,
  badge_variants varchar(30) DEFAULT NULL,
  affix_tab smallint DEFAULT 0,
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO oh_sys.sys_menu VALUES (1, 0, 'Dashboard', '概览', '/dashboard', NULL, 1, 0, 0, '', NULL, NULL, NULL, 0, NULL, 'menu', 0, 'lucide:layout-dashboard', 1, 0, 1, NULL, 10000, '2023-09-24 20:13:47', 10000, '2025-05-26 13:39:51');
INSERT INTO oh_sys.sys_menu VALUES (2, 1, 'WorkSpace', '工作台', '/workspace', '/dashboard/workspace/index', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:workspace', 1, 0, 1, NULL, 10000, '2023-09-24 20:13:47', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (3, 1, 'Analytics', '分析页', '/analytics', '/dashboard/analytics/index', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'lucide:area-chart', 1, 1, 1, NULL, 10000, '2023-09-24 20:13:47', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (5, 10, 'SystemSetting', '系统设置', '/system/setting', NULL, 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:settings-check', 0, 0, 1, NULL, 10000, '2025-06-22 14:05:38', 10000, '2025-06-22 14:18:50');
INSERT INTO oh_sys.sys_menu VALUES (6, 10, 'SystemAuthority', '权限管理', '/system/authority', NULL, 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:delivery-settings', 0, 0, 1, NULL, 10000, '2025-06-22 14:07:19', 10000, '2025-06-22 14:19:02');
INSERT INTO oh_sys.sys_menu VALUES (7, 10, 'SystemApp', '系统应用', '/system/app', NULL, 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:app', 0, 0, 1, NULL, 10000, '2025-06-22 14:09:17', 10000, '2025-06-22 14:19:12');
INSERT INTO oh_sys.sys_menu VALUES (10, 0, 'System', '系统管理', '/sys', NULL, 1, 0, 0, '', NULL, 'dot', NULL, 0, NULL, 'menu', 0, 'carbon:settings', 1, 0, 1, NULL, 10000, '2023-09-24 20:13:47', 10000, '2025-05-07 10:16:33');
INSERT INTO oh_sys.sys_menu VALUES (11, 5, 'Menu', '菜单管理', '/system/menu', '/system/menu/list', 1, 0, 0, NULL, 'new', 'normal', 'default', 0, NULL, 'menu', 0, 'carbon:menu', 1, 0, 1, NULL, 10000, '2023-06-04 21:03:59', 10000, '2025-06-22 14:20:37');
INSERT INTO oh_sys.sys_menu VALUES (12, 11, '查询菜单', '查询菜单', '', NULL, 1, 0, 0, 'sys:menu:list,sys:menu:info,sys:role:menu', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 1, 0, 1, NULL, 10000, '2023-09-24 20:13:47', 10000, '2025-06-06 10:12:33');
INSERT INTO oh_sys.sys_menu VALUES (13, 11, '新增修改菜单', '新增修改菜单', '', NULL, 1, 0, 0, 'sys:menu:save,sys:menu:update,sys:menu:delete', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 1, 0, 1, NULL, 10000, '2023-09-24 20:13:47', 10000, '2025-06-06 10:11:39');
INSERT INTO oh_sys.sys_menu VALUES (15, 6, 'Role', '角色管理', '/system/role', '/system/role/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'mdi:account-group', 1, 0, 1, NULL, 10000, '2023-06-04 21:03:59', 10000, '2025-06-22 14:19:26');
INSERT INTO oh_sys.sys_menu VALUES (16, 15, '查询角色', '查询角色', NULL, NULL, 1, 0, 0, 'sys:role:page,sys:role:list,sys:role:info', NULL, '', NULL, 0, NULL, 'button', 0, NULL, 1, 1, 1, NULL, 10000, '2023-09-24 20:13:47', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (17, 15, '新增修改角色', '新增修改角色', NULL, NULL, 1, 0, 0, 'sys:role:save,sys:role:update,sys:role:delete', NULL, '', NULL, 0, NULL, 'button', 0, NULL, 1, 1, 1, NULL, 10000, '2023-09-24 20:13:47', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (19, 6, 'Dept', '部门管理', '/system/dept', '/system/dept/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:container-services', 1, 0, 1, NULL, 10000, '2023-06-04 21:03:59', 10000, '2025-06-22 14:19:49');
INSERT INTO oh_sys.sys_menu VALUES (20, 19, '查询部门', '查询部门', NULL, NULL, 1, 0, 0, 'sys:dept:list,sys:dept:info', NULL, '', NULL, 0, NULL, 'button', 0, NULL, 1, 1, 1, NULL, 10000, '2023-09-24 20:13:47', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (21, 19, '新增修改部门', '新增修改部门', '', NULL, 1, 0, 0, 'sys:dept:save,sys:dept:update,sys:dept:delete', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-05-08 14:22:58', 10000, '2025-05-08 14:23:29');
INSERT INTO oh_sys.sys_menu VALUES (23, 5, 'Params', '参数管理', '/system/params', '/system/params/index', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:delivery-parcel', 1, 0, 1, NULL, 10000, '2023-06-04 21:03:59', 10000, '2025-06-22 14:20:47');
INSERT INTO oh_sys.sys_menu VALUES (24, 23, '查询参数', '查询参数', '', NULL, 1, 0, 0, 'sys:params:info', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-05-08 14:22:58', 10000, '2025-05-08 14:23:29');
INSERT INTO oh_sys.sys_menu VALUES (25, 23, '新增修改参数', '新增修改参数', '', NULL, 1, 0, 0, 'sys:params:save,sys:params:update,sys:params:delete', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-05-08 14:22:58', 10000, '2025-05-08 14:23:29');
INSERT INTO oh_sys.sys_menu VALUES (27, 6, 'Users', '用户管理', '/system/user', '/system/user/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:user-multiple', 1, 0, 1, NULL, 10000, '2023-06-04 21:03:59', 10000, '2025-06-22 14:19:59');
INSERT INTO oh_sys.sys_menu VALUES (28, 27, '查询用户', '查询用户', '', NULL, 1, 0, 0, 'sys:user:page,sys:user:info,sys:user:export', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-05-08 14:22:58', 10000, '2025-05-08 14:23:29');
INSERT INTO oh_sys.sys_menu VALUES (29, 27, '新增修改用户', '新增修改用户', '', NULL, 1, 0, 0, 'sys:user:save,sys:user:update,sys:user:delete', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-05-08 14:22:58', 10000, '2025-05-08 14:23:29');
INSERT INTO oh_sys.sys_menu VALUES (30, 5, 'Dict', '字典管理', '/system/dict', '/system/dict/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:align-horizontal-left', 0, 0, 1, NULL, 10000, '2025-05-19 09:30:58', 10000, '2025-06-22 14:20:57');
INSERT INTO oh_sys.sys_menu VALUES (31, 30, '查询字典', '查询字典', '', NULL, 1, 0, 0, 'sys:dict:page,sys:dict:info,sys:dict:refreshTransCache', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-05-19 09:32:48', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (32, 30, '新增修改字典', '新增修改字典', '', NULL, 1, 0, 0, 'sys:dict:save,sys:dict:update,sys:dict:delete', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-05-19 09:33:38', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (33, 6, 'Tenant', '租户管理', '/system/tenant', '/system/tenant/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:catalog-publish', 0, 0, 1, NULL, 10000, '2025-05-20 11:07:19', 10000, '2025-06-22 14:20:12');
INSERT INTO oh_sys.sys_menu VALUES (34, 33, '查询租户', '查询租户', '', NULL, 1, 0, 0, 'tenant:member:page,tenant:member:info', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-05-20 11:08:47', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (35, 33, '新增修改租户', '新增修改租户', '', NULL, 1, 0, 0, 'tenant:member:save,tenant:member:update,sys:user:bindTenantUser,sys:user:unBindTenantUser', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-05-20 11:09:21', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (36, 6, 'Post', '岗位管理', '/system/post', '/system/post/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:calls-all', 1, 0, 1, NULL, 10000, '2025-05-20 17:54:23', 10000, '2025-06-22 14:20:26');
INSERT INTO oh_sys.sys_menu VALUES (37, 36, '查询岗位', '查询岗位', '', NULL, 1, 0, 0, 'sys:post:page,sys:post:info', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-05-20 17:55:22', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (38, 36, '新增修改岗位', '新增修改岗位', '', NULL, 1, 0, 0, 'sys:post:save,sys:post:update,sys:post:delete', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-05-20 17:56:26', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (39, 7, 'Attachment', '附件管理', '/system/attachment', '/system/attachment/list', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:file-storage', 0, 0, 1, NULL, 10000, '2025-06-08 11:26:11', 10000, '2025-06-22 14:21:39');
INSERT INTO oh_sys.sys_menu VALUES (40, 39, '查询附件', '查询附件', '', NULL, 1, 0, 0, 'sys:attachment:page', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-06-08 11:27:23', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (41, 39, '新增修改附件', '新增修改附件', '', NULL, 1, 0, 0, 'sys:attachment:save,sys:attachment:delete', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-06-08 11:28:09', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (42, 10, 'Log', '日志管理', '/system/log', NULL, 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:catalog', 0, 0, 1, NULL, 10000, '2025-06-11 17:24:35', 10000, '2025-06-11 17:29:17');
INSERT INTO oh_sys.sys_menu VALUES (43, 42, 'LoginLog', '登录日志', '/system/loginLog', '/system/log/loginLog', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:change-catalog', 0, 0, 1, NULL, 10000, '2025-06-11 17:25:59', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (44, 43, '查询登录日志', '查询登录日志', '', NULL, 1, 0, 0, 'sys:log:login', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-06-11 20:35:32', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (45, 42, 'OpLog', '操作日志', '/system/opLog', '/system/log/opLog', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:border-top', 0, 0, 1, NULL, 10000, '2025-06-11 17:28:36', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (46, 45, '查询操作日志', '查询操作日志', '', NULL, 1, 0, 0, 'sys:operate:all', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-06-11 20:40:14', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (47, 7, 'SystemInterface', '接口管理', '/system/app/manage', '', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:ibm-cloud-vpc-client-vpn', 0, 0, 1, NULL, 10000, '2025-06-22 20:39:43', 10000, '2025-06-22 20:43:16');
INSERT INTO oh_sys.sys_menu VALUES (48, 47, 'SystemAppInterface', '客户端管理', '/system/app/list', '/system/app/list', 1, 0, 0, '', NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:multiuser-device', 0, 0, 1, NULL, 10000, '2025-06-22 20:42:06', 10000, '2025-06-22 20:46:05');
INSERT INTO oh_sys.sys_menu VALUES (49, 48, '查询客户端', '查询客户端', '', NULL, 1, 0, 0, 'sys:app:page,sys:app:info,sys:function:page', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-06-22 20:46:30', 10000, '2025-06-23 15:13:02');
INSERT INTO oh_sys.sys_menu VALUES (50, 48, '新增修改客户端', '新增修改客户端', '', NULL, 1, 0, 0, 'sys:app:save,sys:app:update,sys:app:delete', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-06-24 14:27:08', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (51, 47, 'SystemFunc', '接口管理', '/system/app/func', '/system/app/funcList', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:interface-usage-1', 0, 0, 1, NULL, 10000, '2025-06-25 10:35:16', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (52, 51, '查询接口', '查询接口', '', NULL, 1, 0, 0, 'sys:function:page,sys:function:info', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-06-25 10:36:10', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (53, 51, '新增修改接口', '新增修改接口', '', NULL, 1, 0, 0, 'sys:function:save,sys:function:update,sys:function:delete', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-06-25 11:00:12', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (54, 47, 'SystemAppLog', '接口日志', '/system/app/log', '/system/app/log', 1, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 'menu', 0, 'carbon:catalog-publish', 0, 0, 1, NULL, 10000, '2025-06-25 17:27:26', 10000, '2025-06-25 17:30:01');
INSERT INTO oh_sys.sys_menu VALUES (55, 54, '查询日志', '查询日志', '', NULL, 1, 0, 0, 'sys:app:page', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-06-25 17:28:11', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (56, 54, '删除日志', '删除日志', '', NULL, 1, 0, 0, 'sys:app:delete', NULL, NULL, NULL, 0, NULL, 'button', 0, NULL, 0, 0, 1, NULL, 10000, '2025-06-25 17:28:37', NULL, NULL);
INSERT INTO oh_sys.sys_menu VALUES (57, 43, '删除登录日志', '删除登录日志', '', NULL, 1, 0, 0, 'sys:log:login:delete', NULL, NULL, NULL, 0, NULL, 'menu', 0, NULL, 0, 0, 0, NULL, 10000, '2025-06-25 19:45:26', 10000, '2025-09-18 13:32:58');
...
CREATE TABLE oh_sys.sys_role (
  ...
  data_scope smallint DEFAULT NULL,
  db_status smallint DEFAULT '1',
...
-- Comments for sys_role_data_scope
...
CREATE TABLE oh_sys.sys_user (
  ...
  dept_id bigint DEFAULT NULL,
  super_admin smallint DEFAULT NULL,
  status smallint DEFAULT NULL,
  ...
  updater bigint DEFAULT NULL,
  update_time timestamp DEFAULT NULL,
  pwd_modify_time timestamp DEFAULT NULL,
  user_key varchar(60) DEFAULT NULL,
  tenant_id varchar(30) DEFAULT NULL,
  PRIMARY KEY (id)
);

-- Comments for sys_user
