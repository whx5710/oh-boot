package com.iris.generator.common.aspect;

import com.iris.generator.common.annotation.EncryptParameter;
import com.iris.generator.common.page.PageResult;
import com.iris.generator.common.utils.EncryptUtils;
...
public class EncryptParameterAspect {
    ...
    private final Logger log = LoggerFactory.getLogger(EncryptParameterAspect.class);
     ...
     * @throws Throwable
     */
    @Around("execution(* com.iris.generator.controller.DataSourceController.*(..))")
    ...
    private void handleItem(Object item, boolean isDecrypt) {
        ...
        // 只处理在entity包下面的对象
        if (Objects.isNull(item.getClass().getPackage()) || !item.getClass().getPackage().getName().startsWith("com.iris.generator.entity")) {
            return;
        }
