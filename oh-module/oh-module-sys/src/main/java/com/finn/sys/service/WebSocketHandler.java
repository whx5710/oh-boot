...
import com.finn.sys.convert.MessageConvert;
...
public class WebSocketHandler {
        ...
        try {
            ...
            if(!ObjectUtils.isEmpty(list)){
                for(MessageVO messageVO : list){
                    ...
                    if(i == 1){
                        MessageEntity messageEntity = MessageConvert.INSTANCE.convert(messageVO);
    ...
    public void onMessage(String message, Session session) {
        ...
        try {
            user = (UserDetail) ReflectUtil.getValue(principal, "principal");
