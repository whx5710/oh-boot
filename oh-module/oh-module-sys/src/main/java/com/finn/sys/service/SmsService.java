...
import com.finn.sys.cache.SmsPlatformCache;
...
public class SmsService {
     ...
     * 保存短信日志
     */
    public void saveLog(Sms config, String mobile, Map<String, String> params, Exception e) {
     ...
     *  通过轮询算法，获取短信平台的配置
     */
    private Sms roundSmsConfig() {
        List<Sms> platformList = smsPlatformService.listByEnable();
